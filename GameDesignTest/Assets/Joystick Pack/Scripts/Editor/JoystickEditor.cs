...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty invertX;
    ...
    {
        EditorGUILayout.PropertyField(sensitivity, new GUIContent("Sensitivity", "Joystick input sensitivity"));
        EditorGUILayout.PropertyField(invertX, new GUIContent("Invert X", "Inverts the horizontal axis."));
        EditorGUILayout.PropertyField(invertY, new GUIContent("Invert Y", "Inverts the vertical axis."));
